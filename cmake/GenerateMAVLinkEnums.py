...
Usage: python3 generate_mavlink_enums.py <mavlink_include_dir> <output_file>

Example:
    python3 generate_mavlink_enums.py build/_deps/mavlink-build/include/mavlink build/MAVLinkEnums.h
"""
import os
import re
import sys
