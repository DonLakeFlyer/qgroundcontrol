...
public:
    ...
    static constexpr int _ackTimeoutMilliseconds = QGCMAVLink::kMessageRoundTripTimeoutMs;
    // Timeout when actively re-requesting mission items during download.
    static constexpr int _retryTimeoutMilliseconds = QGCMAVLink::kMessageRoundTripTimeoutMs;
