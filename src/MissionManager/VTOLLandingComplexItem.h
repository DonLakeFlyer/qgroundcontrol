...
public:
    VTOLLandingComplexItem(Vehicle* vehicle, QObject* parent);
...
private:
    static LandingComplexItem*  _createItem     (Vehicle* vehicle, QObject* parent) { return new VTOLLandingComplexItem(vehicle, parent); }
